...
fun EditNumberField (
    ...
    TextField(
        value = value, // поле, в котором отображается строковое значение
...
fun Greeting() {
    Column(modifier = Modifier.fillMaxHeight().width(280.dp),
        ...
        TextField(
            ...
            value = "",
            placeholder = {Text(text = "Tip Percentage")},
            onValueChange = {
            })
        Row(
            modifier = Modifier.fillMaxWidth().padding(top = 16.dp),
            horizontalArrangement = Arrangement.SpaceBetween) {
            Text(text = "Round up tip?", modifier = Modifier.padding(top = 12.dp))
